    ...
    def key_map
      {
        ...
        :res_statuschangedate => 'status_change_timestamp',
        :actual_close_date => 'close_date',
        :la_name => 'list_agent_fullname',
        :res_dishwasher_inc => '30',
        :res_disposal_included => '31',
        :res_refrigerator_included => '33',
        :res_dryer_utilities => '34',
        :area => 'area',
        :res__3_4_baths => 'three_qtr_baths',
        :res_full_baths => 'baths_full',
        :res_half_baths => 'baths_half',
        :res_baths_total => 'baths_total',
        :res_bath_downstairs_description => 'bath_down_yn',
        :bedrooms => 'beds_total',
        ...
        :res_lot_sqft => '154',
        :res_community_name => 'community_name',
        :ml_num => 'mls_number',
        :res_lo_name => '171',
        ...
        :sold_term => '233',
        :res_pvspa => 'pv_spa',
        :res_approx_liv_area => 'approx_total_liv_area',
        :status => 'status',
