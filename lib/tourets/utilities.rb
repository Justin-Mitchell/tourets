module TouRETS
  module Utilities
    ...
    def map_res_search_params(search_params)
      Hash[search_params.map {|k, v| [key_map_res[k], v] }]
    end
    
    def map_ver_search_params(search_params)
      Hash[search_params.map {|k, v| [key_map_ver[k], v] }]
    end
    
    def map_lnd_search_params(search_params)
      Hash[search_params.map {|k, v| [key_map_lnd[k], v] }]
    end
    
    def map_rnt_search_params(search_params)
      Hash[search_params.map {|k, v| [key_map_rnt[k], v] }]
    end
    
    def map_mul_search_params(search_params)
      Hash[search_params.map {|k, v| [key_map_mul[k], v] }]
    end
    ...
    def key_map_mul
      {
        ...
        :status => 242,
        :year_built => 264,
        :_1_bedroom__1__1_2_bath => 688,
        :_1_bedroom__1_bath => 689,
        :_1_bedroom_2_bath => 690,
        :_1_bedroom_rent => 692,
        :num_1_bdrm_unfurn => 693,
        :_2_bedroom_1_1__2_bath => 694,
        :_2_bedroom_1_bath => 695,
        :_2_bedroom__2_bath => 696,
        :_2_bedroom_rent => 698,
        :num_2_bdrm_unfurn => 699,
        :_3_bedroom_1_1_2_bath => 700,
        :_3_bedroom_1_bath => 701,
        :_3_bedroom_2_bath => 702,
        :_3_bedroom_rent => 704,
        :num_3_bdrm_unfurn => 705,
