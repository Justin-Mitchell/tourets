    ...
    def key_map
      {
        ...
        :status_change_date => "18"   #DateTime
        ...
        :downstairs_bath_desc => "64",#String
        :bedrooms => "68",            #Integer
        ...
        # :seller_contribution_amount => "232",  #Float
        # :sold_team => "233",    #String
        :has_spa => "236",            #Boolean
        ...
        :elementary_school_k_2 =>"2377",        #String
